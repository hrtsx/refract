...
const ar_catalog = [_]ArMethod{
    ...
    // Singular terminals: collapse the relation to one `Model` instance.
           .{ .name = "first", .facet = .singular },
    .{ .name = "last", .facet = .singular },                  .{ .name = "find", .facet = .singular },
    .{ .name = "find_by", .facet = .singular },               .{ .name = "find_by!", .facet = .singular },
    .{ .name = "take", .facet = .singular },                  .{ .name = "sole", .facet = .singular },
    .{ .name = "find_sole_by", .facet = .singular },          .{ .name = "second", .facet = .singular },
    .{ .name = "third", .facet = .singular },                 .{ .name = "fourth", .facet = .singular },
    .{ .name = "fifth", .facet = .singular },                 .{ .name = "forty_two", .facet = .singular },
    .{ .name = "second_to_last", .facet = .singular },        .{ .name = "third_to_last", .facet = .singular },
    .{ .name = "find_or_create_by", .facet = .singular },     .{ .name = "find_or_create_by!", .facet = .singular },
    .{ .name = "find_or_initialize_by", .facet = .singular }, .{ .name = "create", .facet = .singular },
    .{ .name = "create!", .facet = .singular },               .{ .name = "build", .facet = .singular },
    .{ .name = "first_or_create", .facet = .singular },
    ...
    // Array / Integer / boolean members instead of dropping to nothing.
          .{ .name = "pluck", .facet = .arr },
    .{ .name = "ids", .facet = .arr },                        .{ .name = "to_a", .facet = .arr },
    .{ .name = "to_ary", .facet = .arr },                     .{ .name = "count", .facet = .int },
    .{ .name = "size", .facet = .int },                       .{ .name = "length", .facet = .int },
    .{ .name = "sum", .facet = .int },                        .{ .name = "exists?", .facet = .boolean },
    .{ .name = "any?", .facet = .boolean },                   .{ .name = "empty?", .facet = .boolean },
    .{ .name = "none?", .facet = .boolean },                  .{ .name = "one?", .facet = .boolean },
    .{ .name = "many?", .facet = .boolean },                  .{ .name = "include?", .facet = .boolean },
};
